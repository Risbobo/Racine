...
namespace Racines
{
    public class GameManager : MonoBehaviour
    {
        ...
        [SerializeField] private static float _energyValue;
        ...
        {
            _energyBar.transform.localScale = new Vector3(_energyBarScale.x, _sizeEnergyBar, _energyBarScale.z);
        }
        ...
        public void UpdateEnergy(float energyIncrement)
        {
            ...
            if (_energyValue > 0)
            {
                _sizeEnergyBar = _energyBarScale.y + energyIncrement;
                DrawBoard();
            }
            else
            {
